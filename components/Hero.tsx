...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-[var(--primary)] via-[var(--primary-dark)] to-[var(--accent)]"
    >
      {/* Background Pattern */}
      ...
      />
      <motion.div
        className="absolute bottom-20 right-10 w-96 h-96 bg-[var(--accent)]/20 rounded-full blur-3xl"
        animate={{
          x: [0, -30, 0],
          y: [0, -50, 0],
        }}
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <div className="w-32 h-32 mx-auto rounded-full bg-white/20 backdrop-blur-sm border-4 border-white/30 flex items-center justify-center">
            <span className="text-4xl font-bold text-white">TJ</span>
          </div>
        </motion.div>
        ...
        >
          Hi, I&apos;m{' '}
          <span className="text-yellow-300">Talha Jalil</span>
        </motion.h1>
        ...
        >
          <button
            ...
            className="px-8 py-3 bg-white text-[var(--primary-dark)] font-semibold rounded-full hover:bg-white/90 transition-all duration-300 hover:scale-105 shadow-lg"
          >
            Get In Touch
          </button>
          <button
            onClick={() => handleNavClick('#projects')}
            className="px-8 py-3 bg-transparent border-2 border-white text-white font-semibold rounded-full hover:bg-white hover:text-[var(--primary-dark)] transition-all duration-300 hover:scale-105"
          >
            View My Work
          </button>
        </motion.div>
